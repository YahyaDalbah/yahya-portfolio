...
export default function Contact() {
  ...
  return (
    <div
      id="contact"
      className="flex-1 flex flex-col items-center bg-gray-100 mt-20"
    >
      ...
      <div className=" w-full flex flex-col sm:flex-row justify-evenly p-10">
        ...
        <div className="">
          ...
          <h1>
            Email:{" "}
            <a className="link" href="mailto:yahya1dalbah@gmail.com">
      ...
      <form
        className="flex flex-col w-80 sm:w-30r gap-6 px-5 py-10 contact-shadow"
        ref={form}
        onSubmit={sendEmail}
      >
        {error && !name.current.value ? (
          <p className="-my-1 text-red-500 font-semibold text-center">
        ...
        />
        <input
          className="bg-blue-400 py-1 text-white text-lg cursor-pointer active:translate-y-1 active:shadow-none button"
          type="submit"
          value="Send"
        />
      </form>
      <div className="w-full flex justify-evenly my-7">
        <a
          href="https://www.facebook.com/profile.php?id=100073297607064"
          target={"_blank"}
          className="icon"
        >
